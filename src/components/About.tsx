      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            Backend Development: Strong expertise in C# and ASP
.NET Core (MVC) for building scalable, secure, and
maintainable web applications.
Database Management: Skilled in SQL Server and
MySQL with hands-on experience designing relational
databases and optimizing queries.
Frontend & UI/UX: Proficient in HTML, CSS, JavaScript,
Bootstrap with knowledge of Angular/React for dynamic
interfaces.
Tools & Practices: Visual Studio, Git/GitHub, Agile
teamwork, and clean coding practices.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            ...
            >
              ...
              <p className="text-gray-400 mb-4">
                I specialize in front-end development with React and modern web
                technologies, but I'm also experienced in full-stack development
                and UI/UX design.
              </p>
